...
<circle cx="10.5" cy="10.5" r="7.5" style="fill: #b2b2b2; stroke-width: 2;"></circle>
<path d="M21,21l-5.2-5.2M10.5,3A7.5,7.5,0,1,0,18,10.5,7.5,7.5,0,0,0,10.5,3Z" style="fill: none; stroke: #1C274C; stroke-linecap: round; stroke-linejoin: round; stroke-width: 2;"></path>
</svg>
)";
...
auto GearsIconSVG = R"(
<svg version="1.1" x="0px" y="0px" width="800px" height="800px" viewBox="0 0 256 256">
<path fill="#D1D1D1" d="M120.502,243.45c-7.057,0-12.089-3.771-14.169-10.614c-1.694-5.572-3.675-11.136-5.488-16.045
...
<path fill="#464646" d="M195.82,210.063c-1.146,0.164-2.348-0.763-3.484-1.314c-1.563-0.764-3.158-1.462-4.734-2.195
